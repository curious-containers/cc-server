from cc_server.master_service.scheduling_strategies.task_selection import FIFO
from cc_server.master_service.scheduling_strategies.caching import OneCachePerTaskNoDuplicates
from cc_server.master_service.scheduling_strategies.container_allocation import binpack, spread
